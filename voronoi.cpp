...
void save(int const width, int const height, vector<site> const &sites){
    ...
    for(int y=0;y<height;y++){
        ...
        for(int x=0;x<width;x++){
            ...
            cout<<color.red<<" "<<color.green<<" "<<color.blue<<"\n";
             ...
             image.set_pixel(x,y,color.red*255.0,color.green*255.0,color.blue*255.0);
